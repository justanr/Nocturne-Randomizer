...
class func:
    def __init__(
        self, index, fun_name, ret_type="void", desc="", params=[], long_desc=""
    ):
        self.index = index
        self.name = fun_name
...
# Params
messageIdParam = param(
    "int", "messageId", "Index of message in the current message script"
)
...
posParam = param(
    "int", "variableId", "The return value from comm 0x94 (LOAD_POS_ASSET)"
)

u_int_param = param("int")
u_str_param = param(
    "string",
    desc="Actual value is an index that refers to a string in the current script file. Uses a PUSHSTR command instead of a PUSHIS command.",
)
...
# Functions
comm0 = func(
    0, "MSG", desc="Displays message of index of messageId.", params=[messageIdParam]
)
comm1 = func(
    1,
    "MSG_WND_DSP",
    desc="Displays message window",
    long_desc="\tThe message window display is shown for nearly every message.\n\tOne example where the message window does not appear is during the death cutscene.",
)
comm2 = func(2, "MSG_WND_CLS", desc="Closes message window")
comm3 = func(
    3,
    "MSG_DEC",
    desc="Displays decision message of index of messageID.",
...
comm6 = func(
    6,
    "REMOVE_END_STONE",
    desc="Removes one of the 3 endgame stones.",
    params=[endstoneParam],
)
...
comm7 = func(
    ...
    "BIT_CHK",
    "bool",
    "Returns flag of the given index",
    [flagParam],
    long_desc=flag_long_desc
...
comm8 = func(
    8,
    "BIT_ON",
    desc="Turns on flag of the given index",
    params=[flagParam],
    long_desc=flag_long_desc,
)
comm9 = func(
    9,
    "BIT_OFF",
    desc="Turns off flag of the given index",
    params=[flagParam],
    long_desc=flag_long_desc,
)
commA = func(
    ...
    "int",
    params=[u_int_param],
    desc="Returns a random int from 0 to given int.",
)
...
commE = func(
    0xE, "WAIT", desc="Waits 1/30 of a second * given param", params=[u_int_param]
)
commF = func(
    0xF,
    "FADE_IN",
    desc="Flashes the screen with color (param2) and fades back at (param1) centiseconds.",
    params=[u_int_param, u_int_param],
)
comm10 = func(
    0x10,
    "FADE_OUT",
    desc="Fades the screen with color (param2) and fades in at (param1) centiseconds.",
    params=[u_int_param, u_int_param],
)
...
comm4A = func(
    ...
    "POSITION_MODEL",
    params=[u_int_param, u_int_param],
    desc="(guess) Takes the return from the loaded position of the 1st param, and loads the return from the loaded model in the 2nd param",
)
...
comm5E = func(
    ...
    "int",
    params=[u_int_param, u_int_param],
    desc="Checks if button is pressed. Used for Enter/Open (X) labels.",
)
comm60 = func(
    0x60,
    "RM_FLD_CONTROL",
    desc="Remove player control",
    long_desc="\tTypically done to display a message, to be combined later with 0x61: GIVE_FLD_CONTROL()",
)
comm61 = func(
    0x61,
    "GIVE_FLD_CONTROL",
    desc="Give player back control",
    long_desc="\tThis is typically used after a message is displayed to return control to the player. If not done it'll softlock.",
)
...
comm66 = func(
    0x66, "CALL_EVENT", params=[eventIdParam], desc="Calls event script of the given ID"
)
comm67 = func(
    0x67,
    "CALL_BATTLE",
    params=[battleIdParam],
    desc="Initiates a battle of the given ID",
)
# comm6D = Shows up once in intro. Label as unused?
comm70 = func(
    0x70,
    "ADD_ITEM",
    params=[itemIdParam, u_int_param],
...
comm94 = func(
    ...
    "int",
    params=[u_str_param],
    desc="Loads external assets such as cameras or positions",
)
...
comm97 = func(
    0x97,
    "CALL_NEXT",
    params=[u_int_param, fieldIdParam, locationIdParam],
    desc="Sets a callback to a field and position in that field. 1st param is universally 1.",
)
# comm98 2 parameters. Int and Position. VERY common in Diet building.
# comm99 event only. 190 count
comm9A = func(
    0x9A, "UNUSED_9A", desc=unused_desc
)  # Shows up in 501, 502, 503 which are unused events.
...
commC3 = func(
    ...
    "HUD_DSP",
    params=[u_int_param],
    desc="Displays or removes the HUD using an octet mask.",
)
...
comm121 = func(
    0x121,
    "NAME_CHARCTER",
    desc="Brings up the character name screen. Exclusively for the introduction of the game.",
    params=[u_int_param, u_int_param],
)
...
comm158 = func(
    0x158,
    "ADD_STOCK",
    desc="Adds demon stock. By default starts at 8 and should NEVER go past 12.",
    params=[u_int_param],
)
...
comm6B = func(
    0x6B, "OBJ_PATH_MOVE", "int?", params=[u_int_param, u_int_param, u_int_param]
)
...
comm86 = func(
    ...
    "AI_CHK_ENHOJO",
    "bool",
    params=[support_skill_param],
    desc="Returns if enemy has the specified support skill active",
)
comm87 = func(
    0x87,
    "AI_CHK_FRHOJO",
    "bool",
    params=[support_skill_param],
    desc="Returns if an ally has the specified support skill active",
)
...
commB0 = func(
    ...
    "MODEL_LIGHT_DIR",
    "int?",
    params=[u_int_param, u_int_param, u_flt_param, u_flt_param, u_flt_param],
)
commB5 = func(
    0xB5,
    "SCENE_LIGHT_DIR",
    "int?",
    params=[u_int_param, u_flt_param, u_flt_param, u_flt_param],
)
...
commD7 = func(
    0xD7, "EFFMG1_POS", "int?", params=[u_int_param, u_int_param, u_int_param]
)
commD8 = func(
    0xD8,
    "EFFMG2_POS",
    "int?",
    params=[u_int_param, u_int_param, u_int_param, u_int_param, u_int_param],
)
...
comm103 = func(
    0x103, "ON", "int?", params=[u_int_param, u_int_param, u_str_param, u_int_param]
)
comm104 = func(
    0x104, "OFF", "int?", params=[u_int_param, u_int_param, u_str_param, u_int_param]
)
...
comm110 = func(
    ...
    "GIMIC_HOJI",
    "int?",
    params=[u_int_param, u_int_param, u_int_param, u_int_param],
)
comm129 = func(
    0x129, "BLUR2_PARA", "int?", params=[u_flt_param, u_flt_param, u_int_param]
)
...
comm15B = func(
    0x15B, "AI_TAR_AI", "int?", desc="Targets unit that isn't the main character"
)
comm168 = func(
    0x168, "EFFBED_START2", "int?", params=[u_int_param, u_int_param, u_int_param]
)
